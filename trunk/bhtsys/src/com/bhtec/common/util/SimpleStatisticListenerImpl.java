...
//    private static transient final Log log = LogFactory.getLog(SimpleStatisticListenerImpl.class);
    private static transient final  Logger log = Logger.getLogger(SimpleStatisticListenerImpl.class);
    /**
     * Hit counter
     */
    ...
    public void accessed(CacheMapAccessEvent event) {
        ...
        if (log.isDebugEnabled()) {
            log.info("ACCESS : " + result + ": " + event.getCacheEntryKey());
            log.info("STATISTIC : Hit = " + hitCount + ", stale hit ="
