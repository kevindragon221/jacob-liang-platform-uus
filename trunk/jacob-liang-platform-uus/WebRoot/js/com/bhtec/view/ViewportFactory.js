 ...
 * @author lianglp
 * @version 1.0
 * @class com.bhtec.view.viewport.ViewportFactory
 */
...
var uumRoleUserRefList;//多角色用户角色列表
var changeRoleType;//角色切换方式
...
com.bhtec.view.ViewportFactory = function(config) {
	...
	uumRoleUserRefList = config.uumRoleUserRefList||[];
	changeRoleType = config.changeRoleType||'';
