...
com.bhtec.view.business.commonused.userinfomodify.UserInfoModify = function(config){
	...
	var busiForm = function(configForm){
		...
		var userOldPassword = moduleVOp.textField({
				...
				inputType:'password',
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'userOldPassword'),
				vtype:'alphanum',
				maxLength:15
		});
		...
		var userNewPassword = moduleVOp.textField({
				...
				inputType:'password',
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'userNewPassword'),
				vtype:'alphanum',
				maxLength:15
		});
		...
		var userConfirmPassword = moduleVOp.textField({
				...
				inputType:'password',
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'userConfirmPassword'),
