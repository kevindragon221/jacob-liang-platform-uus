...
com.bhtec.view.business.platform.code.CodeList = function(config){
	...
	var cols = function(){
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'codeEngName'),
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'codeName'),
				dataIndex : 'codeName',
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'moduleName'),
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'codeEffect'),
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'delimite'),
				dataIndex : 'delimite',
				width :  basicConstant.GRID_COL_WIDTH,
				sortable: true
			});
		colsArr.push({
				header : getFormFieldName(xmlDoc,'partNum'),
				dataIndex : 'partNum',
				width : basicConstant.GRID_COL_WIDTH,
				sortable: true
			});
