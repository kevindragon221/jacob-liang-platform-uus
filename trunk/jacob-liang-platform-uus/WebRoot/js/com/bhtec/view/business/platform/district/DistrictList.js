...
com.bhtec.view.business.platform.district.DistrictList = function(config){
	...
	var cols = function(){
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'districtName'),
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'districtCode'),
				dataIndex : 'districtCode',
				width : basicConstant.GRID_COL_WIDTH,
				sortable: true 
			});
		colsArr.push({
				header : getFormFieldName(xmlDoc,'districtPostal'),
				dataIndex : 'districtPostal',
				width : basicConstant.GRID_COL_WIDTH,
				sortable: true 
			});
		colsArr.push({
				header : getFormFieldName(xmlDoc,'districtTelcode'),
				dataIndex : 'districtTelcode',
				width : basicConstant.GRID_COL_WIDTH,
				sortable: true 
			});
		colsArr.push({
				header : getFormFieldName(xmlDoc,'districtLevel'),
				dataIndex : 'districtLevel',
				width : basicConstant.GRID_COL_WIDTH,
				sortable: true 
			});
		colsArr.push({
				header : getFormFieldName(xmlDoc,'upDistrict'),
