...
com.bhtec.view.business.platform.district.DistrictVOp = function(config){
	...
	var busiForm = function(configForm){
		...
		var districtName = moduleVOp.textField({
				...
				maxLength  : 10,
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'districtName'),
				value:moduleData.districtName||''
		});
		...
		var districtCode = moduleVOp.textField({
				...
				fieldLabel : getFormFieldName(xmlDoc,'districtCode'),
				vtype:'alphanum'
		});
		...
		var districtPostal = moduleVOp.numberField({
				...
				fieldLabel : getFormFieldName(xmlDoc,'districtPostal'),
				allowDecimals : false,
				emptyText:'请输入数字'
		});
		...
		var districtTelcode = moduleVOp.numberField({
				...
				fieldLabel : getFormFieldName(xmlDoc,'districtTelcode'),
				maxLength  : 10,
				allowDecimals : false,
				emptyText:'请输入数字'
		});
		...
		var districtLevel = moduleVOp.comboBox({
				id : "districtLevel",
				fieldLabel : getFormFieldName(xmlDoc,'districtLevel'),
		...
		var upDistrict = moduleVOp.triggerField({
				id : 'upDistrictNameId',
				name : 'upDistrictName',
				fieldLabel : getFormFieldName(xmlDoc,'upDistrict'),
				value:moduleData.upDistrictName||'',
				allowBlank:false,
				window:treeWin
		});
