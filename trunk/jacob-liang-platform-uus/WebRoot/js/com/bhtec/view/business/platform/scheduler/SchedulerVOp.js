...
com.bhtec.view.business.platform.scheduler.SchedulerVOp = function(config){
	...
	var funForm = function(configForm){
		...
		var jobClassDescript = moduleVOp.textField({
				...
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'jobClassDescript'),
		...
		var timeExpress = moduleVOp.textField({
				...
				name : 'timeExpress',
				allowBlank:false,
				fieldLabel : getFormFieldName(xmlDoc,'timeExpress'),
		...
		var repeatTime = moduleVOp.numberField({
				...
				maxLength:2,
				fieldLabel : getFormFieldName(xmlDoc,'repeatTime'),
				allowDecimals : false,
				allowBlank:false
		});
		//时间间隔
		var splitTime = moduleVOp.numberField({
				...
				maxLength:10,
				fieldLabel : getFormFieldName(xmlDoc,'splitTime'),
				allowDecimals : false,
				allowBlank:false
		});
