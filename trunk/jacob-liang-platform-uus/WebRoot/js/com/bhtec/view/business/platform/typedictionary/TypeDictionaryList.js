...
com.bhtec.view.business.platform.typedictionary.TypeDictionaryList = function(config){
	...
	var queryCondition = function(){ 
		...
		queryArr.push({
					...
					items : [com.bhtec.view.util.CommonWidgets.prototype.textField({
								id:bigTypeName_q,
								width:150,
								fieldLabel : getFormFieldName(xmlDoc,'bigTypeName'),
								listeners: {
					...
					items : [com.bhtec.view.util.CommonWidgets.prototype.textField({
								id:bigTypeCode_q,
								width:150,
								fieldLabel : getFormFieldName(xmlDoc,'bigTypeCode'),
								listeners: {
					                specialkey: function(field, e){
					                    if (e.getKey() == e.ENTER) {
					                       query();
        			...
        			var grid = new Ext.grid.GridPanel({
				        ...
				        cm: new Ext.grid.ColumnModel({				           
				            columns: [
				                ...
				                {
				                	header: '<span style=color:blue;>'+getFormFieldName(xmlDoc,'smallTypeName')+' </span>',  
				                	...
				                	header: '<span style=color:blue;>'+getFormFieldName(xmlDoc,'smallTypeCode')+' </span>',  
	...
	var cols = function(){
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'bigTypeName'),
		...
		colsArr.push({
				header : getFormFieldName(xmlDoc,'bigTypeCode'),
