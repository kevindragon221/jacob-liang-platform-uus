...
com.bhtec.view.business.uum.group.generalGroup.GeneralGroupMember = function(config) {
	...
	var upOrgName = commWidgets.triggerField({
			...
			width:120,
			fieldLabel : getFormFieldName(xmlDoc,'organ'),
	...
	var role = commWidgets.comboBox({
			...
			fieldLabel : getFormFieldName(xmlDoc,'role'),
			width:120,
	...
	var memberType = commWidgets.radio({
			...
			name : "memberType",
			value:'',
			fieldLabel : getFormFieldName(xmlDoc,'memberType'),
			width:100,
			items:[
	...
	var leftMultiSelPanel = commWidgets.panel({
				autoWidth:true,
				autoHeight : true,
				items : [{
							xtype : "multiselect",
	...
	var rightMultiSelPanel = commWidgets.panel({
				autoWidth:true,
				autoHeight : true,
				items : [{
							xtype : "multiselect",
	...
	var multiPanel = new com.bhtec.view.business.uum.group.MultiSelect({
		leftTitle : '待选用户',
		rightTitle : '已选用户',
