...
com.bhtec.view.business.uum.group.generalGroup.GeneralGroupVOp = function(config){
	...
	var busiForm = function(configForm){
		...
		var generalGroupInfo = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'generalGroupInfoAdd'),				//窗口title
		...
		var userMember = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'generalGroupAdd'),				//窗口title
	...
	var saveForm = function(){
		var configSave = {
			title:getFormFieldName(xmlDoc,'generalGroupInfoAdd')
		}
		busiForm(configSave);
	}
	/**
