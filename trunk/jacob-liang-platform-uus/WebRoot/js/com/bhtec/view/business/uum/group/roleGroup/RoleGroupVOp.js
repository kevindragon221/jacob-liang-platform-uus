...
com.bhtec.view.business.uum.group.roleGroup.RoleGroupVOp = function(config){
	...
	var busiForm = function(configForm){
		...
		var roleGroupInfo = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'roleGroupInfoAdd'),				//窗口title
		...
		var roleMember = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'roleGroupAdd'),				//窗口title
	...
	var saveForm = function(){
		var configSave = {
			title:getFormFieldName(xmlDoc,'roleGroupInfoAdd')
		}
		busiForm(configSave);
	}
	/**
