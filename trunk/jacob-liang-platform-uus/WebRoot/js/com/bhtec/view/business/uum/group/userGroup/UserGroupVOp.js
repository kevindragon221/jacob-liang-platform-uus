...
com.bhtec.view.business.uum.group.userGroup.UserGroupVOp = function(config){
	...
	var busiForm = function(configForm){
		...
		var userGroupInfo = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'userGroupInfoAdd'),				//窗口title
		...
		var userMember = moduleVOp.fieldSet({
			title:getFormFieldName(xmlDoc,'userGroupAdd'),				//窗口title
	...
	var saveForm = function(){
		var configSave = {
			title:getFormFieldName(xmlDoc,'userGroupInfoAdd')
		}
		busiForm(configSave);
	}
	/**
