...
com.bhtec.view.business.uum.organ.OrganVOp = function(config){
	...
	var busiForm = function(configForm){
		...
		var orgFullName = moduleVOp.textField({
				...
				maxLength  : 60,
				fieldLabel : getFormFieldName(xmlDoc,'orgFullName')			
		});
		...
		var orgAddress1 = moduleVOp.textField({
				...
				maxLength  : 100,
				fieldLabel : getFormFieldName(xmlDoc,'orgAddress1')			
		});
		//联系地址2
		var orgAddress2 = moduleVOp.textField({
				...
				maxLength  : 100,
				fieldLabel : getFormFieldName(xmlDoc,'orgAddress2')			
		});
		//联系电话1
		var orgTel1 = moduleVOp.numberField({
				...
				maxLength  : 15,
				fieldLabel : getFormFieldName(xmlDoc,'orgTel1'),
				emptyText:'请输入数字',
				allowDecimals : false
		});
		//联系电话2
		var orgTel2 = moduleVOp.numberField({
				...
				maxLength  : 15,
				fieldLabel : getFormFieldName(xmlDoc,'orgTel2'),
				allowDecimals : false,
				emptyText:'请输入数字'
		});
		//成立日期
		var orgBeginDate = moduleVOp.dateField({
				...
				format:'Y-m-d',
				fieldLabel : getFormFieldName(xmlDoc,'orgBeginDate')			
		});
		
		//机构类型
		var orgType = moduleVOp.comboBox({
				id : "orgType",
				fieldLabel : getFormFieldName(xmlDoc,'orgType'),
						...
						listeners :{
					        load:function(){
					        	if(moduleData.orgType){
						        	...
						        	getExtCmpById('orgType').setValue('headquarters');
					          	}
					        }
					     }
					}),
		...
		var orgPostal = moduleVOp.numberField({
				name : "orgPostal",
				fieldLabel : getFormFieldName(xmlDoc,'orgPostal'),
		...
		var orgLegal = moduleVOp.textField({
				name : "orgLegal",
				fieldLabel : getFormFieldName(xmlDoc,'orgLegal'),
		...
		var orgTaxNo = moduleVOp.textField({
				name : "orgTaxNo",
				fieldLabel : getFormFieldName(xmlDoc,'orgTaxNo'),
				maxLength:25,
				vtype:'alphanum',
		...
		var orgRegNo = moduleVOp.textField({
				...
				maxLength:25,
				vtype:'alphanum',
				fieldLabel : getFormFieldName(xmlDoc,'orgRegNo'),
		...
		var orgBelongDistName = moduleVOp.triggerField({
				...
				fieldLabel : getFormFieldName(xmlDoc,'orgBelongDist'),
		...
		var upOrgName = moduleVOp.triggerField({
				id : 'upOrgName',
				name : 'upOrgName',
				fieldLabel : getFormFieldName(xmlDoc,'upOrgId'),
