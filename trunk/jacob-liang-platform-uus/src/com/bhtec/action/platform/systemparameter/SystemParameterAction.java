...
import static com.bhtec.common.constant.PojoVariable.SYSPL_SYS_PARAMETER;
...
public class SystemParameterAction extends PlatformBaseAction implements ModelDriven<SysplSysParameter> {
	...
	public void saveSystemParameter() {
		try {
			...
			long id = this.getPrimaryKeyByPojoName(SYSPL_SYS_PARAMETER);
			sysplSysParameter.setParaId(id);
