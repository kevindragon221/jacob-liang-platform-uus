...
public class UumUser implements java.io.Serializable {
	...
	private Set uumUserAgents = new HashSet(0);
	...
	public UumUser(Long userId, UumOrgan uumOrgan, String userCode,
			...
			Set uumRoleUserRefs, Set uumPrivileges) {
		this.userId = userId;
		...
		this.uumUserAgents = uumUserAgents;
	...
	public Set getUumUserAgents() {
		return this.uumUserAgents;
	}

	public void setUumUserAgents(Set uumUserAgents) {
		this.uumUserAgents = uumUserAgents;
	}
	@JSON(serialize=false)
